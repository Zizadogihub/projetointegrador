...
?>
  ...
  <div id="formulario">
    ...
    <img src="cachorro.png" id="cachorro">


    <form action="functions.php" method="post">
      <div class="fullwith">
        <h1>Se torne um parceiro!</h1>


        <div id="frase">
          <h6>Para se tornar um parceiro crie sua conta</h6>
        </div>
      </div>
      <div id="login">
        ...
        <input type="text" id="i" name="raça" placeholder="Nome:"><br><br>

        <label for="idade"></label>
        <input type="number" id="i" name="idade" placeholder="Idade:"><br><br>

        <label for="cor"></label>
        <input type="text" id="i" name="cor" placeholder="Cor:"><br><br>

        <label for="deficiencia"></label>
        <input type="text" id="i" name="deficiencia" placeholder="deficiencia:"><br><br>

        <label for="caracteristica"></label>
        <input type="text" id="i" name="caracteristica" placeholder="caracteristica:"><br><br>
        <br>
