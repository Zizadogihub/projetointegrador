...
<nav class="navbar navbar-expand-lg bg-body-tertiary" id="parte" >
   ...
   <div class="container-fluid" id="palavras">
     ...
     <div class="collapse navbar-collapse" id="navbarNav" >
       <ul class="navbar-nav">
         <li class="nav-item">
           <a class="nav-link " aria-current="page" href="http://localhost/projetointegrador/paginainicial/index.php#" style="">Voltar</a>
         </li>
         <li class="nav-item">
           <a class="nav-link" href="http://localhost/projetointegrador/paginainicial/animais.php#">Adoção</a>
         </li>
         <li class="nav-item">
...
<select class="form-select" aria-label="Default select example" style="width:250px; margin:0px 500px; position:absolute; ">
  ...
  <option value="7">Mato Grosso</option>
  <option value="8">Rondonia</option>
  <option value="9">Goias</option>
  <option value="10">Maranhao</option>
  <option value="11">Acre</option>
  <option value="12">Amazonas</option>
  <option value="13">Amapa</option>
  <option value="14">Roraima</option>
  <option value="15">Pernambuco</option>
  <option value="16">Rio Grande do Norte</option>
  <option value="17">Para</option>
  <option value="18">Paraiba</option>
  <option value="19">Recife</option>
  <option value="20">Minas gerais</option>
  <option value="21">Ceara</option>
  <option value="22">Tocantins</option>
  <option value="23">Alagoas</option>
  <option value="24">Piaui</option>
  <option value="25">Sergipe</option>
</select>
 

<select class="form-select" aria-label="Default select example" style="width:250px; margin:0px 900px; position:absolute;">
  <option selected>Selecione sua cidade</option>
  <option value="1">Foz do Iguaçu</option>
  <option value="2">Londrina</option>
  <option value="3">Curitiba</option>
</select>


  <div class="container-fluid" style="width:350px; margin:0px 1300px; position:relative; ">
    <form class="d-flex" role="search">
...
<br>
<br>
<div class="card" style="width: 18rem; border-radius:20px; margin:0px 900px; ">
<div id="carouselExampleIndicators" class="carousel slide" >
  ...
  <ul class="list-group list-group-flush">
    ...
    <li class="list-group-item">Deficiencia</li>
  </ul>
  <div class="card-body">
    <button type="submit" class="adotar">Adotar</button> 
    <svg xmlns="http://www.w3.org/2000/svg" style="width:25px;  margin:0px 8px;"  fill="currentColor" class="bi bi-heart" viewBox="0 0 16 16">
  <path d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15"/>
</svg> 
    
<svg xmlns="http://www.w3.org/2000/svg" style="width:25px; margin:0px 8px;" fill="currentColor" class="bi bi-chat-left" viewBox="0 0 16 16">
  <path d="M14 1a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4.414A2 2 0 0 0 3 11.586l-2 2V2a1 1 0 0 1 1-1zM2 0a2 2 0 0 0-2 2v12.793a.5.5 0 0 0 .854.353l2.853-2.853A1 1 0 0 1 4.414 12H14a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z"/>
</svg>
<svg xmlns="http://www.w3.org/2000/svg" style="width:25px; margin:0px 8px;" fill="currentColor" class="bi bi-bookmark" viewBox="0 0 16 16">
